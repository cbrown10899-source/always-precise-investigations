...
```bash
node case-portal/test-worker.mjs   # 401 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 282 checks: the page against the real Worker
```
