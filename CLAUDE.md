...
```bash
node case-portal/test-worker.mjs   # 601 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 417 checks: the page against the real Worker
```
