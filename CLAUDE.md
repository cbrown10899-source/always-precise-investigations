...
```bash
node case-portal/test-worker.mjs   # 388 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 270 checks: the page against the real Worker
```
