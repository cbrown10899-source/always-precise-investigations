...
```bash
node case-portal/test-worker.mjs   # 748 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 663 checks: the page against the real Worker
```
