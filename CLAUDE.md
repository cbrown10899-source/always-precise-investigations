...
```bash
node case-portal/test-worker.mjs   # 416 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 288 checks: the page against the real Worker
```
