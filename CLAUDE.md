...
```bash
node case-portal/test-worker.mjs   # 340 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 245 checks: the page against the real Worker
```
