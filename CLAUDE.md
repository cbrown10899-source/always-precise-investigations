...
```bash
node case-portal/test-worker.mjs   # 345 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 269 checks: the page against the real Worker
```
