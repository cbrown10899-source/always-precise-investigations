...
```bash
node case-portal/test-worker.mjs   # 428 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 292 checks: the page against the real Worker
```
