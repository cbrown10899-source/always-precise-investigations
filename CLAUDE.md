...
```bash
node case-portal/test-worker.mjs   # 971 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 760 checks: the page against the real Worker
```
