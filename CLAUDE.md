...
```bash
node case-portal/test-worker.mjs   # 733 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 653 checks: the page against the real Worker
```
