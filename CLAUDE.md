...
```bash
node case-portal/test-worker.mjs   # 933 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 740 checks: the page against the real Worker
```
