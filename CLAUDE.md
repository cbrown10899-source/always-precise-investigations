...
```bash
node case-portal/test-worker.mjs   # 455 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 303 checks: the page against the real Worker
```
