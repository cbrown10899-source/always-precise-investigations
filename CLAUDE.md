...
```bash
node case-portal/test-worker.mjs   # 598 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 367 checks: the page against the real Worker
```
