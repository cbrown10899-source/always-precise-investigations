...
```bash
node case-portal/test-worker.mjs   # 439 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 298 checks: the page against the real Worker
```
