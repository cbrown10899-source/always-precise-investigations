...
```bash
node case-portal/test-worker.mjs   # 292 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 188 checks: the page against the real Worker
```
