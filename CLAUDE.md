...
```bash
node case-portal/test-worker.mjs   # 610 checks: auth, invites, roles, redaction, rates, ingest
node portal/test-portal.mjs        # 439 checks: the page against the real Worker
```
