...
PLACES = [
    ...
    ("bedford-va", "Bedford", "town", "Bedford County",
     ...
     ["forest-va", "smith-mountain-lake-va", "lynchburg-va", "roanoke-va"]),
    ("smith-mountain-lake-va", "Smith Mountain Lake", "community", "Bedford County",
     "Bedford County Circuit Court",
     "the lake community around Moneta, where the shoreline runs through Bedford and Franklin "
     "counties and many of the homes are second residences",
     ["bedford-va", "rocky-mount-va", "forest-va"]),
    ("roanoke-va", "Roanoke", "city", "Roanoke County",
     ...
     ["salem-va", "vinton-va", "bedford-va", "lynchburg-va"]),
    ("salem-va", "Salem", "city", "Roanoke County",
     "Salem Circuit Court",
     "the independent city on the western side of the Roanoke Valley, home to Roanoke College",
     ["roanoke-va", "vinton-va", "rocky-mount-va"]),
    ("vinton-va", "Vinton", "town", "Roanoke County",
     "Roanoke County Circuit Court",
     "the town at the eastern edge of the Roanoke Valley, first out Route 24 toward Bedford",
     ["roanoke-va", "salem-va", "bedford-va"]),
    ("rocky-mount-va", "Rocky Mount", "town", "Franklin County",
     "Franklin County Circuit Court",
     "the Franklin County seat on Route 220 between Roanoke and the Blue Ridge foothills",
     ["roanoke-va", "smith-mountain-lake-va", "salem-va"]),
