...
| 17. Subjects + vehicles | **done** — 2026-08-13 (structured records on the Subject tab, several per case, vehicles nested; both roles write on cases they can open, edits stamped, no delete; photographs LINKED 2026-08-13: evidence attaches to a subject or an activity moment, thumbnails on the subject card, clip chips on the timeline) |
