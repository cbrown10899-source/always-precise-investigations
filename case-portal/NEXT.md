...
| Unit | PR / SHA | State |
| --- | --- | --- |
| **API Assistant Unit 4** — intake preparation + preview + SIMULATE + `assistant_log` (`ASSISTANT.md` A6–A10). **Schema: one additive table → portal-setup dispatch owed after merge** | in flight on the branch | worker 3080/0 · deploy guard 86/0 · intake 558/0 · visitor 47/0 · e2e running at this write |
