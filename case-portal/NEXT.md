...
| Unit | PR / SHA | State |
| --- | --- | --- |
| **API Assistant Unit 5 + Unit 6 read half** — rate-sheet preparation + preview + SIMULATE (`ASSISTANT.md` A11; pinned mirror of `emailSheet`, byte-equality + refusal-mirror tests) and live billing answers (A12; drafts excluded from outstanding). Unit 6's preparation half DEFERRED — owner question in A12. No schema change | in flight on the branch | worker 3112/0 · deploy guard 86/0 · intake 558/0 · visitor 47/0 · e2e running at this write |
