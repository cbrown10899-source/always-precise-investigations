...
| Retainer payment idempotency (payment + token in one transaction) | **LIVE VERIFIED** — #107/#108/#110 at `2ad0e3c`; build.txt matches master, both deploys green, served page carries the token-keeping branch; worker 981 |
