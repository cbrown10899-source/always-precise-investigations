...
| Unit | PR / SHA | State |
| --- | --- | --- |
| **API Assistant Unit 5** — rate-sheet preparation + preview + SIMULATE (`ASSISTANT.md` A11; pinned mirror of `emailSheet`, byte-equality + refusal-mirror tests). No schema change | in flight on the branch | worker 3105/0 · deploy guard 86/0 · intake 558/0 · visitor 47/0 · e2e running at this write |
